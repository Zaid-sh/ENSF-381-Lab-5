...
function performOperation(operation) {
    ...
    showResult2D('Result', 'matrix3', result); // use suitable function for printing results
}
...
function addMatrices(matrix1, matrix2) {
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        console.error('Matrices dimensions must match for addition');
        return null;
    }
...
const subtractMatrices = function (matrix1, matrix2) {
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        console.error('Matrices dimensions must match for subtraction');
        return null;
    }
...
const multiplyMatrices = (matrix1, matrix2) => {
    if (matrix1[0].length !== matrix2.length){
        console.error('Matrices dimensions are incorrect');
        return null;
    }
